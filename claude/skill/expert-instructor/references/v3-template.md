# Learning Prompt Template v3 (with Module Tasks + Final Exam)
...
Once the student has answered both questions, immediately begin teaching Module 1.
Do not summarise the course plan or list all the modules — just start teaching.
